<%-- 
    Document   : sign-in
    Created on : Jan 11, 2024, 9:32:38 PM
    Author     : thain
--%>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-xl-7 col-xxl-5">
                                <div class="pxp-sign-hero-form-content">
                                    ...
                                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/LoginGoogle/LoginGoogleHandler&response_type=code&client_id=107009318948-o4luvggtpqglu9t9flnhjaq46vfmflij.apps.googleusercontent.com&approval_prompt=force">Login With Google</a>
                                    <form class="mt-4">
